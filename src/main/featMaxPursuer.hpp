#ifndef FEAT_MAX_PURSUER_HPP
#define FEAT_MAX_PURSUER_HPP
...
public:
    ...
    FeatMaxPursuer(const FeatMaxPursuer & other);

    ~FeatMaxPursuer() override = default;
